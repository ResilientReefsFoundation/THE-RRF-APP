...
export const LockOpenIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M18 1.5c2.9 0 5.25 2.35 5.25 5.25v3.75a.75.75 0 0 1-1.5 0V6.75a3.75 3.75 0 1 0-7.5 0v3h3a3 3 0 0 1 3 3v6.75a3 3 0 0 1-3 3H6.75a3 3 0 0 1-3-3v-6.75a3 3 0 0 1 3-3h9v-3c0-2.9 2.35-5.25 5.25-5.25Z" />
  </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a5.971 5.971 0 0 0-.941 3.197m0 a5.976 5.976 0 0 0 1.666 4.057M12 12.75a3.375 3.375 0 1 0 0-6.75 3.375 3.375 0 0 0 0 6.75Zm6.622-6.262a3.375 3.375 0 1 1-5.714 3.556 3.375 3.375 0 0 1 5.714-3.556ZM3.078 10.044a3.375 3.375 0 1 1 5.714-3.556 3.375 3.375 0 0 1-5.714 3.556Z" />
  </svg>
);

export const WrenchIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.423 20.11l3.29-3.29m0 0a3.75 3.75 0 014.674-4.674m-4.674 4.674a3.75 3.75 0 004.674-4.674m-4.674 4.674l3.29-3.29m-6.58 0V4.5m0 0a3.75 3.75 0 014.674-4.674M9.75 4.5h4.5M11.423 20.11H4.5m0 0a3.75 3.75 0 01-4.674-4.674m4.674 4.674a3.75 3.75 0 00-4.674-4.674m4.674 4.674l-3.29-3.29m6.58 0V11.25m0 0a3.75 3.75 0 01-4.674 4.674m4.674-4.674a3.75 3.75 0 00-4.674 4.674m4.674-4.674l-3.29-3.29" />
  </svg>
);
...
export const ThermometerIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v13.5m0 0a3.375 3.375 0 100 6.75 3.375 3.375 0 000-6.75zM9.75 15.75h4.5" />
  </svg>
);
...
export const BeakerIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v1.244c0 .463-.131.916-.375 1.304l-3.25 5.122A1.125 1.125 0 007.125 12h9.75a1.125 1.125 0 001.002-1.63L14.625 5.25a1.125 1.125 0 01-.375-1.304V3.104M9.75 3.104C10.457 2.454 11.233 2.25 12 2.25s1.543.204 2.25.854M9.75 3.104c-.391.362-.835.626-1.5.626s-1.109-.264-1.5-.626m7.5 0c.391.362.835.626 1.5.626s1.109-.264 1.5-.626M3 20.25h18M12 15.75v4.5m-3-4.5v4.5m6-4.5v4.5" />
  </svg>
);
...
export const CloudIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-3.758-3.848 5.25 5.25 0 00-10.233 2.33A4.502 4.502 0 002.25 15z" />
  </svg>
);
...
export const PlayIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 0 1 0 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z" />
  </svg>
);
...
export const BellIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25v.7c0 2.427-1.123 4.643-2.857 6.032a23.848 23.848 0 005.454-1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
  </svg>
);
...
export const SunIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m0 13.5V21m8.966-8.966h-2.25M5.25 12H3m14.593 5.343l-1.591-1.591M6.75 6.75l-1.591-1.591m13.182 0l-1.591 1.591M6.75 17.25l-1.591-1.591M12 18a6 6 0 100-12 6 6 0 000 12z" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 .621-.504 1.125-1.125 1.125H4.875c-.621 0-1.125-.504-1.125-1.125v-4.25m16.5 0a2.25 2.25 0 00-2.25-2.25H18V7.5A2.25 2.25 0 0015.75 5.25h-7.5A2.25 2.25 0 006 7.5v4.4h-1.125a2.25 2.25 0 00-2.25 2.25m16.5 0l-16.5 0" />
  </svg>
);

export const CalendarDaysIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M9 11.25h1.5M12 11.25h1.5M15 11.25h1.5M9 14.25h1.5M12 14.25h1.5M15 14.25h1.5M9 17.25h1.5M12 17.25h1.5M15 17.25h1.5" />
  </svg>
);